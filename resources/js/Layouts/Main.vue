                ...
                <div class="col-lg-12">
                    <div class="client_logo_slider owl-carousel d-flex justify-content-between">
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_1.png`)" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_2.png`)" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_3.png`)" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_4.png`)" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_5.png`)" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img :src="baseUrl(`assets/img/client_logo/client_logo_1.png`)" alt="">
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-6 col-xl-6">
                    <div class="learning_img">
                        <img :src="baseUrl(`assets/img/about_img.png`)" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-7 offset-sm-1">
                    <div class="live_stareams_slide owl-carousel">
                        <div class="live_stareams_slide_img">
                            <img :src="baseUrl(`assets/img/live_streams_1.png`)" alt="">
                        ...
                        <div class="live_stareams_slide_img">
                            <img :src="baseUrl(`assets/img/live_streams_2.png`)" alt="">
                            <div class="extends_video">
                                <a id="play-video_1" class="video-play-button popup-youtube"
                                   href="https://www.youtube.com/watch?v=pBFQdxA-apI">
                                    <span class="fas fa-play"></span>
                            ...
                            <div class="col-lg-6">
                                <div class="single_war_text text-center">
                                    ...
                                    <div class="war_text_item d-flex justify-content-around align-items-center">
                                        <img :src="baseUrl(`assets/img/war_logo_1.png`)" alt="">
                                        <h2>190<span>vs</span>189</h2>
                                        <img :src="baseUrl(`assets/img/war_logo_2.png`)" alt="">
                                    </div>
                ...
                <div class="col-xl-12">
                    <div class="gallery_part_item">
                        <div class="grid">
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_1.png')"
                               class="grid-item bg_img img-gal grid-item--height-1"
                               :style="{ backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_1.png')})` }">
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_2.png')" class="grid-item bg_img img-gal"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_2.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_3.png')" class="grid-item bg_img img-gal"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_3.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_5.png')"
                               class="grid-item bg_img img-gal grid-item--height-2"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_5.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_7.png')"
                               class="grid-item bg_img img-gal grid-item--height-2"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_7.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_6.png')"
                               class="grid-item bg_img img-gal grid-item--width-1"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_6.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
                            ...
                            <a :href="baseUrl('assets/img/gallery/gallery_item_4.png')"
                               class="grid-item bg_img img-gal sm_weight  grid-item--height-1"
                               :style="{backgroundImage: `url(${baseUrl('assets/img/gallery/gallery_item_4.png')})` }">
                                <div class="single_gallery_item">
                                    <div class="single_gallery_item_iner">
                                        <div class="gallery_item_text">
                                            <i class="ti-zoom-in"></i>
